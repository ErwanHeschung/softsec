...
SRCS = $(SRC_DIR)/sectrans.c $(SRC_DIR)/server.c $(UTILS_PARAM_DIR)/param.c $(UTILS_FILE_DIR)/file.c $(UTILS_KEY_MANAGER_DIR)/key_manager.c
CLIENT_OBJS = $(OBJ_DIR)/sectrans.o $(OBJ_DIR)/param.o $(OBJ_DIR)/file.o $(OBJ_DIR)/key_manager.o
SERVER_OBJS = $(OBJ_DIR)/server.o $(OBJ_DIR)/param.o $(OBJ_DIR)/file.o $(OBJ_DIR)/key_manager.o
